...
This directory never contacts Azure. The [round controller](../../docs/azure-validation-round.md) can apply an admitted plan only after the approved managed identity and pinned tooling are present; live create stays `NotStarted` without them.
