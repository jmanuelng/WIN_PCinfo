...
To understand the maintainer-only controller that admits one fresh private Windows 11 client, drives it through VM Agent Run Command, and proves Zero Round Residue, read [One fresh Azure validation round](docs/azure-validation-round.md). It is a controller or DEV tracer and does not deliver a Preview or Supported claim.
