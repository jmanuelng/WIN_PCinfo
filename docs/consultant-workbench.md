...
- [One fresh Azure validation round](azure-validation-round.md) walks one private Windows 11 client through synthetic VM Agent control and Zero Round Residue. Live create stays `NotStarted` on this host. Completing that controller does not deliver `CAP-0028` or create a Preview or Supported claim.
