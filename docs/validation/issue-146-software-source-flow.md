...
## Acceptance refresh after bounded repair #179

The original maximum-delivery blocker is resolved by source `8f7cbe6250418586f4f946b190debf03b35db545`, with focused evidence in [the #179 record](issue-179-report-composability.md). The unchanged retained SoftwareInventoryContract maximum now passes. On generated candidate SHA-256 `b42309abb78df5fe2bddbecc4832d372d2889bc1d24e9a52b5ef0073dbe3ba09` (3,221,099 bytes), the full Comprehensive maximum preserves 128 registrations, eight Complete scopes and 128 conservative annotations through verified protection, reopening, named fields/provenance, deliberate export and cleanup. HTML is 259,499 bytes; distinct maximum-byte Unicode/escaped evidence is 261,963 bytes. Both fit the unchanged 262,144-byte boundary. Larger rendered overflow still refuses honestly with cleanup.

Affected controlled source Complete/DeniedUser and security Active/Denied report cases, recognition logical/integrity failures, report cultures and protected-package/viewing/export gates also passed at this source. The earlier 11-case source matrix remains explicitly tied to its original revision; its unchanged source behavior is not relabeled as new live or exact-candidate validation.

Fresh #179 Standards review reports zero hard violations and one nonblocking tuple-key duplication judgment; fresh Spec reports zero actionable findings and explicitly confirms resolution of #146's inherited blocker. The earlier #146 review found no introduced source defect. This refresh completes the automated implementation acceptance for #146, pending merged delivery before issue closure. Full #158/final regression and actual #161 comparisons remain pending; WinGet remains deferred. The failure and pending-review sections above are retained historical evidence. This addition changes documentation only.
