...
$allowedWorkflows = @(
    'Assessment', 'RecipientProfileSetup', 'RestrictedReportExport', 'Help', 'About', 'Verify', 'VerifyAttestation'
)
$allowedModes = @('Guided', 'Automation')
Assert-Equal $true (
    $headerText.Contains("ValidateSet('Assessment', 'RecipientProfileSetup', 'RestrictedReportExport', 'Help', 'About', 'Verify', 'VerifyAttestation')")
) 'Help, About, Verify, and VerifyAttestation are first-class generated-application workflows'
