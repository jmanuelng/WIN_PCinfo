...
$cases=@(
    @{scenario='Workgroup';exit=0;outcome='Completed';applied='Complete';configured='Complete';control='Complete';count=1;appliedFinding='Informational';localFinding='Informational';orderFinding='ExpectedCondition'},
    @{scenario='Domain';exit=0;outcome='Completed';applied='Complete';configured='Complete';control='Complete';count=2;appliedFinding='Informational';localFinding='Informational';orderFinding='ExpectedCondition'},
    @{scenario='UserAndComputerRsop';exit=0;outcome='Completed';applied='Complete';configured='Complete';control='Complete';count=3;appliedFinding='Informational';localFinding='Informational';orderFinding='ExpectedCondition'},
    @{scenario='MissingRsop';exit=10;outcome='CompletedWithGaps';applied='Unsupported';configured='Complete';control='Complete';count=0;appliedFinding='Indeterminate';localFinding='Informational';orderFinding='Indeterminate'},
    @{scenario='StaleRegistry';exit=10;outcome='CompletedWithGaps';applied='Complete';configured='Partial';control='Complete';count=2;appliedFinding='Informational';localFinding='Indeterminate';orderFinding='ExpectedCondition'},
    @{scenario='DeniedAdministrator';exit=10;outcome='CompletedWithGaps';applied='Denied';configured='Denied';control='Denied';count=0;appliedFinding='Indeterminate';localFinding='Indeterminate';orderFinding='Indeterminate'},
    @{scenario='DeniedSystem';exit=10;outcome='CompletedWithGaps';applied='Complete';configured='Complete';control='Complete';count=2;appliedFinding='Informational';localFinding='Informational';orderFinding='ExpectedCondition'},
    @{scenario='NonEnglish';exit=0;outcome='Completed';applied='Complete';configured='Complete';control='Complete';count=2;appliedFinding='Informational';localFinding='Informational';orderFinding='ExpectedCondition'},
    @{scenario='AppliedOrderConflict';exit=0;outcome='Completed';applied='Complete';configured='Complete';control='Complete';count=2;appliedFinding='Informational';localFinding='Informational';orderFinding='NeedsAttention'},
    @{scenario='AccountLockout';exit=0;outcome='Completed';applied='Complete';configured='Complete';control='Complete';count=1;appliedFinding='Informational';localFinding='Informational';orderFinding='ExpectedCondition'},
