...
Assert-Equal 'Win32_Service; HKLM WinRM Service ADMX policy; Registry64 HKLM WSMAN Service auth_certificate DWORD; up to 32 Listener selectors: Port,enabled DWORD' $policy.sourceCatalog[12].interface `
    'WinRM declares finite request-free policy, service and explicit configuration sources'
